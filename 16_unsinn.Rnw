...
\begin{itemize}
 ...
 Unterschied zwischen den Gruppen rein zufallsbedingt ist 
 -- was wir schon wussten -- oder 
 ...
 was stimmt \emph{und} was wir noch nicht wussten.
 ...
 Wichtige Hintergrundsvariable können natürlich in der Analyse berücksichtigt werden, aber das
 ...
 und die Funktion \texttt{walkthough\_blocking()} im \texttt{cannonball}-Package).
