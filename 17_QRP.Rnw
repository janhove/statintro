\chapter{Signifikanztests und fragwürdige Forschungspraktiken}\label{ch:QRP}
...
Eine gute Übersicht über diese Probleme in Buchform
ist \citet[][\textit{The seven deadly sins of psychology}]{Chambers2017}.
...
\begin{itemize}
 ...
 gibt; wenn nicht, weitere Daten erheben;\footnote{Wenn man dies selber vorhat, sollte man sich bei etwa \citet{Lakens2014} darüber schlau machen, wie man die Daten zu analysieren hat. Die relevanten Entscheidungen müssen übrigens \emph{vor} der Datenerhebung getroffen werden, nicht erst nachher!}
 
 \item Kontrollvariablen erst in der Analyse berücksichtigen,
 wenn das Ergebnis ohne sie nicht-signifikant ist;\footnote{Das Problem hierbei ist \emph{nicht}, dass Kontrollvariablen in der Analyse
